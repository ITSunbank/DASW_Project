...
//------- Funciones estAticas -------
    ...
    static createFromJson(jsonValue) {  //MEtodos que pertenecen a la clase, no al objeto, eso es el static. Para poder hacer un User.cleanObject() por ejemplo.
    ...
    static createFromObject(obj) {
        ...
        //Convert from newUser to User instance
